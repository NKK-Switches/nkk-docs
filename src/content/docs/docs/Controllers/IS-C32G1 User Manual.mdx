...
<image src="/assets/C32G1-top.png" width="400"/>
...
<div style={{ display: "flex", gap: "20px", alignItems: "flex-end" }}>
  <div style={{ textAlign: "center" }}>
    ...
    <image src="/assets/IS-L02A1-C.png" width="200"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-L02A1-CS</div>
    <image src="/assets/IS-L02A1-CS.png" width="200"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-L02H2-CS</div>
    <image src="/assets/IS-L02H2-CS.png" width="200"/>
  </div>  
</div>
...
32 31 30 30 34 30 30 33 converted from ASCII hex is 0x21004003 (0b00100001 00000000 01000000 00000011) Bits 0, 1, 14, 23, and 29 are high, meaning switches 1, 2, 15, 24, and 30 are all pressed. (Switch numbers are 0-indexed). Examples of single switch presses are:
...
<image src="/assets/color-table-64x32.png" width="1000"/>
...
Refer to the IS-C32G1 Command List xlsx file for the full list of commands and examples. The command list as well as example images and attributes can be downloaded here:

<LinkCard
  title="IS-C32G1 Documents"
  href="/assets/downloads/IS-C32G1-Documents-Rev-D.zip"
/>
...
<image src="/assets/l02g1-dimensions.png" width="600"/>

Logic board dimensions for L02H2:

<image src="/assets/l02h2-dimensions.png" width="600"/>

Logic board dimensions for L04G2:

<image src="/assets/l04g2-dimensions.png" width="600"/>

Logic board dimensions for L16G2:

<image src="/assets/l16g2-dimensions.png" width="600"/>
