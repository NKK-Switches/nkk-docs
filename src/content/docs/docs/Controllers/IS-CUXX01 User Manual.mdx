...
- 2.4A maximum @5VDC (All 64 switches changing simultaneously)
- Two options for input voltage:
    1. +5VDC
    2. +9VDC to +24VDC

For Rev C boards and above, when the 0-ohm resistor labeled “Jump” is populated, the controller is configured to only accept +5VDC input voltage. If the resistor is removed, the input voltage range will be +9VDC to +24VDC. The controller is shipped with the “Jump” resistor populated by default. 
