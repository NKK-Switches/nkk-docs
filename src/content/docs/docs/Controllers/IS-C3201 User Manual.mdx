...
Refer to the IS-C3201 Command List xlsx file for the full list of commands and examples. The command list as well as example images and attributes can be downloaded here:

<LinkCard
  title="IS-C3201 Documents"
  href="/assets/downloads/IS-C3201-Documents-Rev-E.zip"
/>
