...
<div style={{ display: "flex", gap: "20px", alignItems: "flex-end" }}>
  <div style={{ textAlign: "center" }}>
    ...
    <img src="/src/assets/IS-L0107-IS15ABFP4RGB.png" width="200"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-L0271-C</div>
    <img src="/src/assets/IS-L0271-C.png" width="200"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-L0403-CS</div>
    <img src="/src/assets/IS-L0403-CS.png" width="150"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-L1602-CS</div>
    <img src="/src/assets/IS-L1602-CS.png" width="200"/>
  </div>  
</div>
...
<img src="/src/assets/l0107-dimensions.png" width="600"/>

Logic board dimensions for L0204:

<img src="/src/assets/l0204-dimensions.png" width="600"/>

Logic board dimensions for L0271:

<img src="/src/assets/l0271-dimensions.png" width="600"/>

Logic board dimensions for L0403:

<img src="/src/assets/l0403-dimensions.png" width="600"/>

Logic board dimensions for L1602:

<img src="/src/assets/l1602-dimensions.png" width="600"/>
