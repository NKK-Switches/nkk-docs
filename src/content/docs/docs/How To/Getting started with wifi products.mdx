...
| 4      		| PE_Error_Creating_file_for_upload 		| Restart and retry upload           |
| 5      		| PE_File_not_found_for_delete 				| Check to make sure file is actually valid, and the name is correct           |
| 6      		| BM_Error_Open_BMP_File 					| Check to see if the Bitmap is valid and the name is correct           |
| 7      		| BM_Error_Reading_BMP_Header 				| Check to see of Bitmap is saved correctly           |
| 8      		| BM_Error_Invalid_BMP_Format 				| Bitmap format is invalid           |
| 9      		| BM_Error_Unsupported_BMP_Dimensions 		| Wrong Dimensions for the switch you are using           |
| 10  			| BM_Unsupported_BMP_Type 					| Wrong bitmap type for the switch you are using           |
| 11  			| PE_Failed_to_open_directory_for_delete 	| Restart Device           |
| 12 			| PE_Failed_to_delete_file 					| Restart Device           |
| 13  			| IU_Failed_to_open_directory_for_delete 	| Restart Device             |
| 14  			| IU_Failed_to_delete_file 					| Restart Device             |