...
<div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
  <img src="/src/assets/oled-rocker.png" width="200"/>  
</div>
...
- [Pin-outs](#pin-outs)
- [Switches](#switches)
- [Overview of How to Control the OLED Rocker](#overview-of-how-to-control-the-oled-rocker)
- [OLED Voltage VCC (15V) Requirements](#oled-voltage-vcc-15v-requirements)
- [Communication to OLED Rocker](#communication-to-oled-rocker)
  - [OLED Commands](#oled-commands)
  - [Communication Protocol](#communication-protocol)
  - [Memory](#memory)
  - [Command for Writing Image Data](#command-for-writing-image-data)
- [Sample Schematic for Multi-Rocker Controller](#sample-schematic-for-multi-rocker-controller)
- [How to Control the OLED Rocker](#how-to-control-the-oled-rocker)
  - [Power Up](#power-up)
  - [Initialization](#initialization)
  - [Writing an image](#writing-an-image)
- [Commands](#commands)
    - [Software Reset Command](#software-reset-command)
    - [Display ON/OFF Command](#display-onoff-command)
    - [Display Standby Mode Command](#display-standby-mode-command)
    - [Brightness Level Command](#brightness-level-command)
    - [Specifying the Window Size for Writing Data to Memory Commands](#specifying-the-window-size-for-writing-data-to-memory-commands)
    - [Writing Data to Memory Command](#writing-data-to-memory-command)
    - [Direction of Writing to Memory Command](#direction-of-writing-to-memory-command)
    - [Direction of Refreshing the OLED from Memory Command](#direction-of-refreshing-the-oled-from-memory-command)
    - [Start Point of Refreshing the OLED from Memory (Manual Scrolling)](#start-point-of-refreshing-the-oled-from-memory-manual-scrolling)
- [Scrolling (Screen saver)](#scrolling-screen-saver)
- [Operating Lifetime](#operating-lifetime)
...
<img src="/src/assets/oled-rocker-communication.png" width="550"/>
...
<img src="/src/assets/oled-rocker-memory-map.png" width="400" id="oled-rocker-memory-map.png"/>
...
<img src="/src/assets/schematic-oled-rocker.png" width="500"/>
...
<img src="/src/assets/oled-rocker-power-sequence.png" width="600"/>
...
<img src="/src/assets/oled-rocker-writing-direction.png" width="650"/>
...
*Display Direction*
<img src="/src/assets/oled-rocker-display-direction.png" width="400"/>
