...
<div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
  <img src="/src/assets/oled-frameless.png" width="200"/>
  <img src="/src/assets/standard-oled.png" width="190"/>
  <img src="/src/assets/oled-display.png" width="170"/>  
</div>
...
- [Part Numbers](#part-numbers)
  - [Switches](#switches)
  - [Engineering Developments Kits](#engineering-developments-kits)
- [Pin-outs](#pin-outs)
- [Design Considerations](#design-considerations)
  - [1. Power Requirements VCC (16V)](#1-power-requirements-vcc-16v)
  - [2. Communication](#2-communication)
  - [3. Hardware and Layout](#3-hardware-and-layout)
  - [4. Controlling Many OLED Switches or Displays](#4-controlling-many-oled-switches-or-displays)
  - [5. SCK Frequency](#5-sck-frequency)
  - [6. Running Video](#6-running-video)
- [Operating Life](#operating-life)
- [Initialization](#initialization)
- [Memory Format](#memory-format)
- [Specifying a Memory Window for Downloading](#specifying-a-memory-window-for-downloading)
- [Pixels and Image Format](#pixels-and-image-format)
- [Display Commands Available](#display-commands-available)
- [Additional Commands Available](#additional-commands-available)
- [Scrolling (Screensaver)](#scrolling-screensaver)
- [Graphic Commands](#graphic-commands)
- [Initialization Options](#initialization-options)
- [Sample Schematic for a Multi-switch Controller](#sample-schematic-for-a-multi-switch-controller)
...
| -------------------------------------------------------------------------------- | --------- | ------ | ----------- |
| Frameless OLED Pushbutton <img src="/src/assets/oled-frameless.png" width="50"/> | ISF15ACP4 | 96x64  | AT9704-085L |
| OLED Pushbutton <img src="/src/assets/standard-oled.png" width="50"/>            | ISC15ANP4 | 64x48  | AT9704-085L |
| OLED Display <img src="/src/assets/oled-display.png" width="43"/>                | ISC01P    | 52x36  | AT9704-085M |
...
<img src="/src/assets/IS-ENG-KIT-7-FF.png" width="300"/>
...
<img src="/src/assets/equation-oled-fps.png" width="300"/>
...
<img src="/src/assets/oled-memory-map.png" width="500"/>
...
<img src="/src/assets/oled-bgr.png" width="500"/>
...
<img src="/src/assets/oled-bgr-565.png" width="500"/>
...
<img src="/src/assets/schematic-oled.png" width="500"/>
