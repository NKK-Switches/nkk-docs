...
<img src="/src/assets/s0109.png" width="300"/>
...
- [S0109 General Features](#s0109-general-features)
- [Backlighting](#backlighting)
- [Attributes](#attributes)
- [Hardware](#hardware)
  - [Dimensions](#dimensions)
  - [Application Interface Header (J1) pinout](#application-interface-header-j1-pinout)
- [Connecting to Application](#connecting-to-application)
- [IS-S0109DEM Evaluation Kit](#is-s0109dem-evaluation-kit)
- [IS-S0109DEM Operational Overview](#is-s0109dem-operational-overview)
  - [Pinout used in IS-S0109DEM](#pinout-used-in-is-s0109dem)
- [UART Communication](#uart-communication)
    - [Command to Download Image to Flash](#command-to-download-image-to-flash)
    - [Command to Disable All the Functions](#command-to-disable-all-the-functions)
    - [Command to Enable All the Functions](#command-to-enable-all-the-functions)
    - [Command to Upload the Set Up](#command-to-upload-the-set-up)
    - [Command to set LED Backlight Brightness](#command-to-set-led-backlight-brightness)
    - [Command to Set LCD Contrast](#command-to-set-lcd-contrast)
    - [Command to Save the Set Up](#command-to-save-the-set-up)
    - [Command to Set Amber and Red Color for the Battery](#command-to-set-amber-and-red-color-for-the-battery)
    - [Command to Check the Connection](#command-to-check-the-connection)
    - [Command to Display Image from Flash](#command-to-display-image-from-flash)
    - [Command to Fill the Image with the Fill Byte](#command-to-fill-the-image-with-the-fill-byte)
    - [Command to Fill the Indicated Pixel Row Data with the Fill Byte](#command-to-fill-the-indicated-pixel-row-data-with-the-fill-byte)
    - [Command to Create the Image of 6 Characters (Font5x7) from Indicated Start Address](#command-to-create-the-image-of-6-characters-font5x7-from-indicated-start-address)
    - [Command to Create the Image of 4 Characters (Font7x10) from Indicated Start Address](#command-to-create-the-image-of-4-characters-font7x10-from-indicated-start-address)
    - [Command to Change the Backlight Color](#command-to-change-the-backlight-color)
    - [Command to Change PWM Duty Cycle](#command-to-change-pwm-duty-cycle)
    - [Command to Create a Bar Graph](#command-to-create-a-bar-graph)
    - [Command to Upload the Analog and Digital Status](#command-to-upload-the-analog-and-digital-status)
- [IS-S0109DEM Hardware](#is-s0109dem-hardware)
- [Programming](#programming)
  - [1.	Preparing the IS-S0109DEM for Programming](#1preparing-the-is-s0109dem-for-programming)
  - [2. Preparing the MPLAB Program](#2-preparing-the-mplab-program)
  - [3. Programming the S0109](#3-programming-the-s0109)
  - [4. Testing](#4-testing)
- [Warranty](#warranty)
...
<img src="/src/assets/IS-S0109DEM-Parts.png" width="400"/>
...
<div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
  <img src="/src/assets/is-s0109-top.png" width="200"/>
  <img src="/src/assets/is-s0109-bottom.png" width="200"/>  
</div>
...
<img src="/src/assets/s0109-dimensions.png" width="800;"/>


**Application Interface Header (J1)** is a 2x9 header 0.1” x 0.1” for application connections.

<img src="/src/assets/s0109-j1.png" width="300;"/>
...
<img src="/src/assets/IS-S0109DEM.png" width="350;"/>
...
<Card title="NKK Logo Splash Screen ">	
    <img src="/src/assets/s0109-menu1.png" width="100;"/>
    Only seen when first turned on. Stays on only for a few seconds.
</Card>

<Card title= "Battery Charge*">
    <img src="/src/assets/s0109-menu2.png"  width="100;"/>
...
<Card title="LCD Brightness Adjustment">
    <img src="/src/assets/s0109-menu9.png"  width="100;"/>
...
<Card title="LED Brightness Adjustment">
    <img src="/src/assets/s0109-menu10.png"  width="100;"/>
...
<img src="/src/assets/IS-S0109DEM-Idenitier.png" width="500"/>
...
<img src="/src/assets/IS-S0109DEM-Programming.png" width="350"/>
...
<img src="/src/assets/s0109-mplab4.png"/>
...
<img src="/src/assets/IS-S0109DEM.png" width="250;"/>
