...
<img src="/src/assets/IS-ENG-KIT-7-FF.png" width="400"/>  
...
- [Available OLED SmartDisplays](#available-oled-smartdisplays)
- [Possible Engineering Kits Using the S02L2 Controller](#possible-engineering-kits-using-the-s02l2-controller)
- [Firmware Overview](#firmware-overview)
  - [OLED Standard/Frameless/Display Attribute Block](#oled-standardframelessdisplay-attribute-block)
  - [OLED Rocker Attribute Block](#oled-rocker-attribute-block)
- [Operational Overview](#operational-overview)
  - [Power-up Sequence](#power-up-sequence)
  - [OLED Color Main Program](#oled-color-main-program)
  - [Rocker Main Program](#rocker-main-program)
...
- [Commands to the Controller](#commands-to-the-controller)
    ...
    - [Command to Change Brightness Level](#command-to-change-brightness-level)
    - [Command to Add Characters to the Display](#command-to-add-characters-to-the-display)
    - [Command to Add a Line to the Display](#command-to-add-a-line-to-the-display)
    - [Command to Change Character Background and Foreground Colors](#command-to-change-character-background-and-foreground-colors)
    - [Command to Change the Line Color](#command-to-change-the-line-color)
    ...
    - [Command to Designate the Current Engineering Kit Type](#command-to-designate-the-current-engineering-kit-type)
    ...
    - [OLED Standard/Frameless/Display Attribute Block](#oled-standardframelessdisplay-attribute-block-1)
...
The controller used for OLED SmartDisplays is the S02L2. The [schematic](#schematics) is at the end of this document. The C language source codes and a Windows based communication software, Engineering Kits Communicator, can be downloaded [here](https://www.nkkswitches.com/download-software/). The software is designed to download images, attributes, and manual commands as well as display responses from the kit.
...
| OLED Rocker <img src="/src/assets/oled-rocker.png" width="60"/>                  | IS18WWC1W | 96x64  | Panel Mount |
...
<div style={{ display: "flex", gap: "20px", alignItems: "flex-end" }}>
  <div style={{ textAlign: "center" }}>
    ...
    <img src="/src/assets/IS-ENG-KIT-7-DS.png" width="300"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-ENG-KIT-7-FS</div>
    <img src="/src/assets/IS-ENG-KIT-7-FS.png" width="300"/>
  </div>
  <div style={{ textAlign: "center" }}>
  ...
  <div style={{ textAlign: "center" }}>
    ...
    <img src="/src/assets/IS-ENG-KIT-8-R.png" width="300"/>
  </div>
</div>
...
<img src="/src/assets/s02l2-schematics.png"/>
