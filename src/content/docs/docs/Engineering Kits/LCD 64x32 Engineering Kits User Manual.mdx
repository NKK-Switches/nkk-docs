...
<img src="/src/assets/IS-ENG-KIT-6-CH.png" width="400"/>  
...
- [Available LCD 64x32 SmartDisplays](#available-lcd-64x32-smartdisplays)
- [Possible Engineering Kits Using the S02G1 Controller](#possible-engineering-kits-using-the-s02g1-controller)
...
- [Commands to the Controller](#commands-to-the-controller)
    ...
    - [Command to Download LED Brightness Level](#command-to-download-led-brightness-level)
...
The controller used for the LCD 64x32 SmartDisplays is the S02G1. The [schematic](#schematics) is at the end of this document. The C language source codes and a Windows based communication software, Engineering Kits Communicator, can be downloaded [here](https://www.nkkswitches.com/download-software/). The software is designed to download images, attributes, and manual commands as well as display responses from the kit.
...
| ------------------------------------------------------------------------------- | ----------------- | ---------------------------- | -------------------------------------------------------------- |
| LCD 64x32 Pushbutton <img src="/src/assets/64x32.png" width="50"/>                         | IS15EBFP4RGB-09YN | *AT9704-065FH                | Standard size, tactile travel (hybrid of standard and compact) |
...
<div style={{ display: "flex", gap: "20px", alignItems: "flex-end" }}>
  ...
  <div style={{ textAlign: "center" }}>
    ...
    <img src="/src/assets/IS-ENG-KIT-6-SH.png" width="300"/>
  </div>
  <div style={{ textAlign: "center" }}>
    <div style={{ marginBottom: "8px", fontWeight: "bold" }}>IS-ENG-KIT-6-CH</div>
    <img src="/src/assets/IS-ENG-KIT-6-CH.png" width="300"/>
  </div>
</div>
...
<img src="/src/assets/s02g1-schematics.png"/>
